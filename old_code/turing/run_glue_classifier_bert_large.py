...
from src.other_models import BertTokenizer
from utils.optimization import warmup_linear
from old_code.turing.loss import FocalLoss
...
def main():
    ...
    if args.progressive_layer_drop:
        ...
        from old_code.nvidiabert.modelingpreln_layerdrop import BertForSequenceClassification, BertConfig, BertLayer
    elif args.preln:
        from old_code.nvidiabert.modelingpreln import BertForSequenceClassification, BertConfig, BertLayer
    else:
        from nvidiabert.modeling import BertForSequenceClassification, BertConfig, BertLayer
