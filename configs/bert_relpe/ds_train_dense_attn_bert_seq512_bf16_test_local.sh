...
CONFIG=${CONFIG:-${base_dir}/configs/bert_relpe/bert_large_rope_swiglu_long_context_test_local.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/bert_relpe/deepspeed_config_seq512_fp16_test_local.json}
