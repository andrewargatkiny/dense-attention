...
CONFIG=${CONFIG:-${base_dir}/configs/bert_relpe/bert_large_rope_seq512_bf16.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/bert_relpe/deepspeed_config_seq512_bf16.json}

MODEL_CONFIG=${MODEL_CONFIG:-"$CONFIG"}
DATA_CONFIG=${DATA_CONFIG:-"$CONFIG"}
TRAINING_CONFIG=${TRAINING_CONFIG:-"$CONFIG"}
TASK_TYPE=${TASK_TYPE:-"bert_pretraining"}
