...
CONFIG=${CONFIG:-${base_dir}/configs/bert_relpe/bert_large_rope_swiglu_long_context_test.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/bert_relpe/deepspeed_config_fp16.json}
