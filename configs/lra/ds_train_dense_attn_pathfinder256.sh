...
BASE_JOB_NAME="lra_pathfinder_256"
...
--cf ${base_dir}/configs/lra/dense_attn_pathfinder256.json \
...
--seed 100 \
--job_name $JOB_NAME \
--deepspeed_config ${base_dir}/configs/lra/deepspeed_config_pathfinder256_rel_emb.json \
--data_path_prefix "${BASE_DATA_DIR}/lra/pathfinder256_hard/" \
--eval_bs_ratio 2 \
--inputs_logging_ratio 0.1 \
--load_training_checkpoint $CHECKPOINT_BASE_PATH \
--load_checkpoint_id $CHECKPOINT_EPOCH_NAME \
--load_only_weights \
--project_name "lra-pathfinder-256" \
&> ${JOB_NAME}.log
