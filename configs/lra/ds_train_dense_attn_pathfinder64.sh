...
BASE_JOB_NAME="lra_pathfinder_64"
...
--cf ${base_dir}/configs/lra/dense_attn_pathfinder64_rel_emb.json \
--max_seq_length 4096 \
...
--data_path_prefix "${BASE_DATA_DIR}/lra/pathfinder64_hard/" \
--eval_bs_ratio 2 \
--inputs_logging_ratio 0.1 \
--load_training_checkpoint $CHECKPOINT_BASE_PATH \
--load_checkpoint_id $CHECKPOINT_EPOCH_NAME \
--project_name "lra-pathfinder-64" \
&> ${JOB_NAME}.log
