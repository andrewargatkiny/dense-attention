...
CONFIG=${CONFIG:-${base_dir}/configs/lra/linear_transformer/linear_attn_pathfinder32.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/lra/linear_transformer/deepspeed_config_pathfinder32.json}
