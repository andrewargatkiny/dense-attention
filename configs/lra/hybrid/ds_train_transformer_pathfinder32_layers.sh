...
CONFIG=${CONFIG:-${base_dir}/configs/lra/hybrid/transformer_pathfinder32_layers.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/lra/hybrid/deepspeed_config_pathfinder32.json}
