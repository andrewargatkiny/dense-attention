...
CONFIG=${CONFIG:-${base_dir}/configs/glue/mrpc.json}
DS_CONFIG=${DS_CONFIG:-${base_dir}/configs/glue/deepspeed_config_mrpc.json}

MODEL_CONFIG=${MODEL_CONFIG:-"$CONFIG"}
DATA_CONFIG=${DATA_CONFIG:-"$CONFIG"}
TRAINING_CONFIG=${TRAINING_CONFIG:-"$CONFIG"}
TASK_TYPE=${TASK_TYPE:-"glue_with_all_metrics"}

OUTPUT_DIR=${BASE_OUT_DIR}/bert_model_dense_attn_adam_outputs
BASE_JOB_NAME="glue_mrpc"
