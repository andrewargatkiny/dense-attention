...
--cf ${base_dir}/lra_mlm/dense_attn_aan_matching.json \
--max_seq_length 4000 \
--output_dir $OUTPUT_DIR \
--task_type "aan_text_classification_mlm" \
--only_mlm_task \
--deepspeed \
--dense_attention \
--use_local_attention \
...
--num_labels 2 \
--job_name $JOB_NAME \
--deepspeed_config ${base_dir}/lra_mlm/deepspeed_config_aan_matching.json \
