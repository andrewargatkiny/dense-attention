...
BASE_JOB_NAME="lra_pathfinder_128_mlm"
...
--cf ${base_dir}/lra_mlm/dense_attn_pathfinder_rel_emb.json \
--max_seq_length 16384 \
--output_dir $OUTPUT_DIR \
--task_type "sequence_classification_mlm" \
--only_mlm_task \
--deepspeed \
--dense_attention \
--eval_train_data \
...
--mask_token_id 256 \
--job_name $JOB_NAME \
--deepspeed_config ${base_dir}/lra_mlm/deepspeed_config_pathfinder_rel_emb.json \
--data_path_prefix "${BASE_DATA_DIR}/lra/path-x/" \
--ckpt_to_save 10 \
--use_nvidia_dataset \
--eval_bs_ratio 2 \
